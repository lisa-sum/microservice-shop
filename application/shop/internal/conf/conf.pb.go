...
type Service struct {
	...
	Account *Service_Account `protobuf:"bytes,1,opt,name=account,proto3" json:"account,omitempty"`
...
func (x *Service) GetAccount() *Service_Account {
	if x != nil {
		return x.Account
	}
	return nil
...
func (x *Service_Account) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Service_Account) ProtoMessage() {}

func (x *Service_Account) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Service_Account.ProtoReflect.Descriptor instead.
func (*Service_Account) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1, 0}
}

func (x *Service_Account) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0xb9, 0x01, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x33, 0x0a, 0x07, 0x61,
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x73,
	...
	0x12, 0x2d, 0x0a, 0x05, 0x67, 0x6f, 0x6f, 0x64, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x17, 0x2e, 0x73, 0x68, 0x6f, 0x70, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x2e, 0x47, 0x6f, 0x6f, 0x64, 0x73, 0x52, 0x05, 0x67, 0x6f, 0x6f, 0x64, 0x73, 0x1a,
	0x25, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6e,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6a, 0x77, 0x74, 0x4b, 0x65, 0x79, 0x22, 0xb4, 0x02, 0x0a,
	0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x29, 0x0a, 0x04, 0x68, 0x74, 0x74, 0x70, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x73, 0x68, 0x6f, 0x70, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x48, 0x54, 0x54, 0x50, 0x52, 0x04, 0x68, 0x74,
	0x74, 0x70, 0x12, 0x29, 0x0a, 0x04, 0x67, 0x72, 0x70, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	...
	0x2e, 0x73, 0x68, 0x6f, 0x70, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x44,
	...
	0x32, 0x14, 0x2e, 0x73, 0x68, 0x6f, 0x70, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61,
	...
	0x19, 0x5a, 0x17, 0x73, 0x68, 0x6f, 0x70, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Service)(nil),             // 1: shop.api.Service
	(*Trace)(nil),               // 2: shop.api.Trace
	(*Registry)(nil),            // 3: shop.api.Registry
	(*Auth)(nil),                // 4: shop.api.Auth
	(*Server)(nil),              // 5: shop.api.Server
	(*Data)(nil),                // 6: shop.api.Data
	(*Service_Account)(nil),     // 7: shop.api.Service.Account
	(*Service_Goods)(nil),       // 8: shop.api.Service.Goods
	(*Registry_Consul)(nil),     // 9: shop.api.Registry.Consul
	(*Server_HTTP)(nil),         // 10: shop.api.Server.HTTP
	(*Server_GRPC)(nil),         // 11: shop.api.Server.GRPC
	(*Data_Database)(nil),       // 12: shop.api.Data.Database
	(*Data_Redis)(nil),          // 13: shop.api.Data.Redis
	(*durationpb.Duration)(nil), // 14: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	5,  // 0: shop.api.Bootstrap.server:type_name -> shop.api.Server
	6,  // 1: shop.api.Bootstrap.data:type_name -> shop.api.Data
	2,  // 2: shop.api.Bootstrap.trace:type_name -> shop.api.Trace
	4,  // 3: shop.api.Bootstrap.auth:type_name -> shop.api.Auth
	1,  // 4: shop.api.Bootstrap.service:type_name -> shop.api.Service
	7,  // 5: shop.api.Service.account:type_name -> shop.api.Service.Account
	8,  // 6: shop.api.Service.goods:type_name -> shop.api.Service.Goods
	9,  // 7: shop.api.Registry.consul:type_name -> shop.api.Registry.Consul
	10, // 8: shop.api.Server.http:type_name -> shop.api.Server.HTTP
	11, // 9: shop.api.Server.grpc:type_name -> shop.api.Server.GRPC
	12, // 10: shop.api.Data.database:type_name -> shop.api.Data.Database
	13, // 11: shop.api.Data.redis:type_name -> shop.api.Data.Redis
